...
CREATE TABLE "draft_tokens" (
	...
	"token" text NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "draft_tokens_post_id_unique" UNIQUE("post_id"),
	CONSTRAINT "draft_tokens_token_unique" UNIQUE("token")
);
--> statement-breakpoint
...
CREATE TABLE "reactions" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "reactions_user_post_unique" UNIQUE("post_id","user_identifier")
);
--> statement-breakpoint
...
ALTER TABLE "draft_tokens" ADD CONSTRAINT "draft_tokens_post_id_posts_id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
